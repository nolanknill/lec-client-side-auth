...
const users = {
  fahd: {
    ...
    posts: [
      {
        id: 1,
        title: "Japanese cars give me life"
      },
      {
        id: 2,
        title: "I don't like the Celtics"
      }
    ]
  },
  nolan: {
  ...
  siulok: {
    ...
    posts: [
      {
        id: 1,
        title: "Rick & Morty would make a good pod review theme",
      }
    ]
  },
  andrew: {
    ...
    posts: [
      {
        id: 1,
        title: "Maybe the Leafs are cursed"
      },
      {
        id: 2,
        title: "Maybe everything in CANADA is upside-down."
      }
    ]
  }
}
...
app.get('/posts', authorize, (req, res) => {
  ...
  res.json({
    ...
    posts: users[req.jwtDecoded.username].posts
  });
});
